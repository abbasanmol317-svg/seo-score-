  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-slate dark:prose-invert max-w-none">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">2. Use of AI</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">3. Cookies</h2>
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
        ...
        <section className="bg-slate-100 dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800">
